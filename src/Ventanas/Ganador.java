...
public class Ganador extends javax.swing.JDialog {
    ...
    public Ganador(java.awt.Frame parent, boolean modal,String gnador) {
        super(parent, modal);
        this.ganador=gnador;
        initComponents();
    ...
    private void initComponents() {
        ...
        lblNombre.setText("Felicitaciones");
        lblNombre.setText("Felicitaciones "+ ganador);
        jPanel1.add(lblNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 20, 470, -1));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 190, 130, -1));
